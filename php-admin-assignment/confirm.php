...
<body>
    ...
    <!--I know you said the admin page should only be accessible through the url, 
    but I couldn't figure out how to run it properly. I'm sure you know how to do that, but 
    I wanted an alternative way to view the page just in case, so I added this button. -->
    <!--I also wasn't sure how to remove old records from when I was still debugging and testing the site,
    so there are a few with missing values and placeholders. -->
    <form action="http://localhost/php-admin-assignment/admin.php" 
